...
java -Dconfig.file=./jes.conf -jar target/scala-2.11/cromwell-*.jar run src/bin/travis/resources/centaur.wdl --inputs src/bin/travis/resources/centaur.inputs | tee log.txt
